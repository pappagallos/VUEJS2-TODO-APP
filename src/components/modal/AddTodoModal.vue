  ...
  <transition>
    <div class="modal">
      ...
      <div class="modal-btn">
        ...
        <button class="btn-submit" @click="addTodo">등록</button>
      </div>
    </div>
  </transition>
</template>
...
export default {
  ...
  methods: {
    closeTodoModal() {
      this.initAddTodoModal();
      eventBus.$emit("addTodoModal:closeModal");
    },
